...
with col1:
    ...
    if tem_estruturas:
        ...
        if estrutura_escolhida:
            ...
            if estrutura_atual:
                tipo_poste_default = estrutura_atual['tipo_poste']
                fixacao_default = estrutura_atual['fixacao']
                locacao_default = estrutura_atual['locacao']
                num_circuitos_default = estrutura_atual['circuito']
                ...
                dist_f4_default = estrutura_atual['dist_f4']
                dist_f5_default = estrutura_atual['dist_f5']
                dist_f6_default = estrutura_atual['dist_f6']
