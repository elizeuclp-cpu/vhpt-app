...
# ===================================================
# FUNÇÃO PARA CARREGAR ESTRUTURAS (OPCIONAL)
# ===================================================
@st.cache_data
def carregar_estruturas():
    """Carrega a planilha de estruturas se existir"""
    try:
...
# ===================================================
# FUNÇÕES AUXILIARES (MESMAS DA VERSÃO ORIGINAL)
# ===================================================
...
# ===================================================
# VERIFICAR SE EXISTE PLANILHA
# ===================================================
estruturas_disponiveis = carregar_estruturas()
tem_planilha = len(estruturas_disponiveis) > 0

# ===================================================
# INTERFACE STREAMLIT - 2 COLUNAS (ORIGINAL RESTAURADA)
# ===================================================
...
with col1:
    ...
    # Se houver planilha, oferecer opção de carregar estrutura
    if tem_planilha:
        modo_estrutura = st.radio("Modo de entrada", ["Manual", "Carregar estrutura"], index=0, horizontal=True)
        
        if modo_estrutura == "Carregar estrutura":
        ...
        # MODO MANUAL (sem planilha) - IGUAL AO ORIGINAL
        tipo_poste = st.selectbox("Tipo de poste", ["Circular", "Duplo T"], index=1)
        fixacao = st.selectbox("Tipo de fixação", ["suspensao", "ancoragem"], index=1, 
                               format_func=lambda x: "Suspensão" if x == "suspensao" else "Ancoragem")
        if fixacao == "suspensao":
    ...
    if modo_estrutura == "Carregar estrutura" and estrutura_atual:
        num_circuitos_display = "Circuito Duplo" if is_duplo else "Circuito Simples"
        st.info(f"Circuitos: {num_circuitos_display}")
    else:
...
with col2:
    ...
    if tem_pr_check:
        if modo_estrutura == "Carregar estrutura" and estrutura_atual:
            ...
            dist_pr_val = st.number_input("Distância PR ao topo (m)", value=float(dist_pr), step=0.05)
...
# ===================================================
# BOTÃO DE CÁLCULO (MESMO CÓDIGO ORIGINAL)
# ===================================================
...
if st.button("🔍 Calcular Esforço no Poste", type="primary", use_container_width=True):
    try:
        ...
        # ===================================================
        # HIPÓTESE 4: CABO CONDUTOR ROMPIDO (simplificada para não estourar limite)
        # ===================================================
        ...
        # ===================================================
        # EXIBIR RESULTADOS (COMPLETO COMO ORIGINAL)
        # ===================================================
        st.markdown("---")
        ...
        parametros_dict = {
            ...
            "Circuitos": "Circuito Duplo" if is_duplo else "Circuito Simples",
            "Deflexão (δ)": f"{delta}°",
