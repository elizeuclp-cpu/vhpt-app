...
with col1:
    ...
    if 'atualizar' in st.session_state:
        tipo_poste_default = st.session_state.atualizar['tipo_poste']
        fixacao_default = st.session_state.atualizar['fixacao']
        locacao_default = st.session_state.atualizar['locacao']
        num_circuitos_default = st.session_state.atualizar['num_circuitos']
        tem_pr_default = st.session_state.atualizar['tem_pr']
        dist_pr_default = st.session_state.atualizar['dist_pr']
        dist_f1_default = st.session_state.atualizar['dist_f1']
        dist_f2_default = st.session_state.atualizar['dist_f2']
        dist_f3_default = st.session_state.atualizar['dist_f3']
        dist_f4_default = st.session_state.atualizar['dist_f4']
        dist_f5_default = st.session_state.atualizar['dist_f5']
        dist_f6_default = st.session_state.atualizar['dist_f6']
    else:
...
if st.button("🔍 Calcular Esforço no Poste", type="primary", use_container_width=True):
    try:
        ...
        fv_max = D1 * pressao_vento        peso_composto = np.sqrt(peso1**2 + fv_max**2)
