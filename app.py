...
with col1:
    ...
    # Seletor de estruturas e botão restaurar
    if tem_estruturas:
        ...
        # Botão RESTAURAR
        if st.button("🔄 Restaurar valores da estrutura", use_container_width=True):
            if estrutura_selecionada:
                ...
                if estrutura_atual:
                    ...
                    st.session_state.restaurar_estrutura = {
                    ...
                    st.success(f"✅ Valores restaurados para '{estrutura_selecionada}'")
                    st.rerun()
            else:
                st.warning("⚠️ Selecione uma estrutura primeiro.")
    
    # Valores padrão (vêm da estrutura restaurada ou padrão)
    if 'restaurar_estrutura' in st.session_state:
        tipo_poste_default = st.session_state.restaurar_estrutura['tipo_poste']
        fixacao_default = st.session_state.restaurar_estrutura['fixacao']
        locacao_default = st.session_state.restaurar_estrutura['locacao']
        num_circuitos_default = st.session_state.restaurar_estrutura['num_circuitos']
        tem_pr_default = st.session_state.restaurar_estrutura['tem_pr']
        dist_f1_default = st.session_state.restaurar_estrutura['dist_f1']
        dist_f2_default = st.session_state.restaurar_estrutura['dist_f2']
        dist_f3_default = st.session_state.restaurar_estrutura['dist_f3']
        dist_f4_default = st.session_state.restaurar_estrutura['dist_f4']
        dist_f5_default = st.session_state.restaurar_estrutura['dist_f5']
        dist_f6_default = st.session_state.restaurar_estrutura['dist_f6']
        dist_pr_default = st.session_state.restaurar_estrutura['dist_pr']
    else:
